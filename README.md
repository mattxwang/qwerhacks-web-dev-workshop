...
* [Understanding the Template](#understanding-the-template)
    * [Understanding the Template: App Structure](#understanding-the-template-app-structure)
    * [Understanding the Template: Imports](#understanding-the-template-imports)
    * [Understanding the Template: Classes](#understanding-the-template-classes)
    * [Understanding the Template: Render Function](#understanding-the-template-render-function)
    * [Understanding the Template: JSX](#understanding-the-template-jsx)
    * [Understanding the Template: Export](#understanding-the-template-export)
* [Basic App Layout](#basic-app-layout)
    * [Basic App Layout: Quick Header](#basic-app-layout-quick-header)
    * [Basic App Layout: Adding Inputs](#basic-app-layout-adding-inputs)
    * [Basic App Layout: Adding a Button](#basic-app-layout-adding-a-button)
* [React Fundamentals](#react-fundamentals)
    * [Why Components](#why-components)
    * [React Fundamentals: Creating a Component](#react-fundamentals-creating-a-component)
    * [An Interlude: More on Classes, and this](#an-interlude-more-on-classes-and-this)
    * [React Fundamentals: this and props](#react-fundamentals-this-and-props)
    * [React Fundamentals: state (conceptual)](#react-fundamentals-state-conceptual)
    * [React Fundamentals: this.setState (conceptual)](#react-fundamentals-thissetstate-conceptual)
    * [React Fundamentals: State and Component Generation](#react-fundamentals-state-and-component-generation)
    * [React Fundamentals: State, Binding, and Event Handlers](#react-fundamentals-state-binding-and-event-handlers)
